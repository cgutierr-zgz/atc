...
class BombillaWidget extends StatefulWidget {
  ...
  const BombillaWidget({super.key, required this.model});

  @override
  BombillaWidgetState createState() => BombillaWidgetState();
}

class BombillaWidgetState extends State<BombillaWidget>
    with BombillaModelObserver {
  String get asset =>
      'assets/light-bulb-${widget.model.isOn ? 'on' : 'off'}.png';
